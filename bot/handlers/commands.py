...
...
    """
    await message.reply(
        welcome_text, reply_markup=WeatherKeyboards.main_menu(), parse_mode="Markdown"
    )
...
🆘 **Допомога по боту:**...
    """
    await message.reply(
        help_text, reply_markup=WeatherKeyboards.main_menu(), parse_mode="Markdown"
    )
...
async def settings_handler(message: Message):
    ...
    await message.reply(
        summary, reply_markup=WeatherKeyboards.settings_menu(), parse_mode="Markdown"
    )
